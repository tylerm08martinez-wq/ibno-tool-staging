...
//     "summary": "…one or two lines, naming the judgement calls…",
...
//
// DECISIONS TYLER SHOULD KNOW GO IN `summary`, NEVER IN A NEW FIELD (#1019).
// The temptation is a `decisions: []` array, and it is a trap: a field nobody
// renders is a field nobody writes, and the judgement calls are exactly what he
// is checking on staging. One prose field that is always displayed beats a
// structured one that is sometimes.
//
